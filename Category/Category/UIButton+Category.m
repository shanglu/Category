    ...
    dispatch_source_set_event_handler(_timer, ^{
        if (timeOut <= 0) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [self setAttributedTitle:[titleString changeColor:[UIColor colorWithHexString:@"eea204"] andRange:NSMakeRange(0, titleString.length)] forState:UIControlStateNormal];
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [self setAttributedTitle:[titleString changeColor:[UIColor colorWithHexString:@"999999"] andRange:NSMakeRange(titleString.length - title.length, title.length)] forState:UIControlStateNormal];
